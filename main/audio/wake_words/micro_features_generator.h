...
#ifndef AUDIO_WAKE_WORDS_MICRO_FEATURES_GENERATOR_H_
#define AUDIO_WAKE_WORDS_MICRO_FEATURES_GENERATOR_H_
...
#endif  // AUDIO_WAKE_WORDS_MICRO_FEATURES_GENERATOR_H_
